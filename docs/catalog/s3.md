...
Once you have stored your credentials, you can create a server to connect to S3:
...
For S3-compliant providers like Wasabi, you can use the following configuration:
