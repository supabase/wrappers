    ...
    pub mod wrappers {
                    ...
                    match l9 {
                        0 => {
                            let e = {
                                ...
                                let l13 = i32::from(*ptr8.add(12).cast::<u16>());
                                let l14 = *ptr8.add(16).cast::<*mut u8>();
                                let l15 = *ptr8.add(20).cast::<usize>();
                                let base22 = l14;
                                let len22 = l15;
                                ...
                                let l24 = *ptr8.add(28).cast::<usize>();
                                let len25 = l24;
        ...
        pub mod jwt {
            ...
            static __FORCE_SECTION_REF: fn() =
                super::super::super::__link_custom_section_describing_imports;
            use super::super::super::_rt;
            pub type JwtError = _rt::String;
            pub type JwtResult = Result<_rt::String, JwtError>;
            #[allow(unused_unsafe, clippy::all)]
            pub fn encode(
                payload: &[(_rt::String, _rt::String)],
                algo: &str,
                key: &str,
                ttl_hours: u32,
            ) -> JwtResult {
                unsafe {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "supabase:wrappers/jwt@0.1.0")]
                    extern "C" {
                        #[link_name = "encode"]
                        fn wit_import(
                            _: *mut u8,
        ...
        pub mod stats {
            ...
            impl ::core::fmt::Debug for Metric {
                fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
                    match self {
                        Metric::CreateTimes => f.debug_tuple("Metric::CreateTimes").finish(),
            ...
            pub fn inc_stats(fdw_name: &str, metric: Metric, inc: i64) {
                unsafe {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "supabase:wrappers/stats@0.1.0")]
                    extern "C" {
                        #[link_name = "inc-stats"]
                        fn wit_import(_: *mut u8, _: usize, _: i32, _: i64);
                    }
                    ...
                    wit_import(ptr0.cast_mut(), len0, result1, _rt::as_i64(&inc));
                }
            }
            #[allow(unused_unsafe, clippy::all)]
            ...
            pub fn set_metadata(fdw_name: &str, metadata: &Metadata) {
                unsafe {
                    ...
                    wit_import(ptr0.cast_mut(), len0, result2_0, result2_1, result2_2);
                }
            }
        }
        ...
        pub mod utils {
            ...
            pub fn report_info(msg: &str) {
                unsafe {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "supabase:wrappers/utils@0.1.0")]
                    extern "C" {
            ...
            pub fn cell_to_string(cell: Option<&Cell>) -> _rt::String {
                unsafe {
                    ...
                    struct RetArea([::core::mem::MaybeUninit<u8>; 8]);
                    let mut ret_area = RetArea([::core::mem::MaybeUninit::uninit(); 8]);
                    let (result4_0, result4_1, result4_2, result4_3) = match cell {
                        Some(e) => {
                            use super::super::super::supabase::wrappers::types::Cell as V2;
                            let (result3_0, result3_1, result3_2) = match e {
                                ...
                                V2::I8(e) => (
                                    1i32,
                                    ::core::mem::MaybeUninit::new(i64::from(_rt::as_i32(e)) as u64),
                                    0usize,
                                ),
                                V2::I16(e) => (
                                    2i32,
                    ...
                    wit_import(result4_0, result4_1, result4_2, result4_3, ptr5);
...
macro_rules! __export_snowflake_impl {
...
#[doc(inline)]
pub(crate) use __export_snowflake_impl as export;

#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.25.0:snowflake:encoded world"]
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 3665] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xd1\x1b\x01A\x02\x01\
...
\x04\x01\x20supabase:wrappers/routines@0.1.0\x05\x0b\x04\x01&supabase:snowflake-\
fdw/snowflake@0.1.0\x04\0\x0b\x0f\x01\0\x09snowflake\x03\0\0\0G\x09producers\x01\
